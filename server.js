...
app.get('/api/brygady-folders', (req, res) => {
    const miasto = req.query.miasto || 'Rzeszów';
    const dirPath = path.join(__dirname, 'Brygady', miasto, 'WYNIKI', 'Gotowe_brygady');
    ...
    fs.readdir(dirPath, {
        ...
        res.json(folders); // <-- To musi być JSON
    });
});
...
app.get('/api/brygada', (req, res) => {
    ...
    const filePath = path.join(__dirname, 'Brygady', 'Rzeszów', 'WYNIKI', 'Gotowe_brygady', wartoscdnia, 'PojazdyLIVE.txt');
...
app.get('/api/vehiclesKrk', async (req, res) => {
    try {
        const response = await fetch('https://api.ttss.pl/vehicles/buses/');
        const html = await response.text();

        res.set('Content-Type', 'text/html');
        res.send(html);
    } catch (error) {
        console.error('Błąd proxy TTSS:', error);
...
app.get('/api/data', async (req, res) => {
    try {
        const brygadaNumber = req.query.brygada || '1'; // Default to 1 if not provided
        const miasto = req.query.miasto || 'Error'; // Domyślnie 'Rzeszów', jeśli nie podano
        const dataPath = path.join(__dirname, 'Brygady', miasto, 'WYNIKI', 'Gotowe_brygady', brygadaNumber);
...
app.put('/updateKierunki', (req, res) => {
    ...
    const filePath = path.join(__dirname, 'Brygady', 'Rzeszów', 'WYNIKI', 'Kierunki.txt');
...
app.get('../../Brygady/WYNIKI/Gotowe_brygady/:folder/Podmiana_list.txt', (req, res) => {
    ...
    if (folder === '1') {
        filePath = path.join(__dirname, 'Brygady', 'Rzeszów', 'WYNIKI', 'Gotowe_brygady', '1', 'Podmiana_list.txt');
    } else if (folder === '2') {
        filePath = path.join(__dirname, 'Brygady', 'Rzeszów', 'WYNIKI', 'Gotowe_brygady', '2', 'Podmiana_list.txt');
    } else if (folder === '3') {
        filePath = path.join(__dirname, 'Brygady', 'Rzeszów', 'WYNIKI', 'Gotowe_brygady', '3', 'Podmiana_list.txt');
    } else if (folder === '4') {
        filePath = path.join(__dirname, 'Brygady', 'Rzeszów', 'WYNIKI', 'Gotowe_brygady', '4', 'Podmiana_list.txt');
    } else {
...
app.get('../../Brygady/WYNIKI/Gotowe_brygady/:folder/PodmianaBAZA_list.txt', (req, res) => {
    ...
    // Ustawienie odpowiedniego path w zależności od folderu
    if (folder === '1') {
        filePath = path.join(__dirname, 'Brygady', 'Rzeszów', 'WYNIKI', 'Gotowe_brygady', '1', 'PodmianaBAZA_list.txt');
    } else if (folder === '2') {
        filePath = path.join(__dirname, 'Brygady', 'Rzeszów', 'WYNIKI', 'Gotowe_brygady', '2', 'PodmianaBAZA_list.txt');
    } else if (folder === '3') {
        filePath = path.join(__dirname, 'Brygady', 'Rzeszów', 'WYNIKI', 'Gotowe_brygady', '3', 'PodmianaBAZA_list.txt');
    } else if (folder === '4') {
        filePath = path.join(__dirname, 'Brygady', 'Rzeszów', 'WYNIKI', 'Gotowe_brygady', '4', 'PodmianaBAZA_list.txt');
    } else {
        return res.status(404).send('Nieznana ścieżka');
    }
...
app.get('../../Brygady/WYNIKI/Gotowe_brygady/:folder/Rezerwa_list.txt', (req, res) => {
    ...
    // Ustawienie odpowiedniego path w zależności od folderu
    if (folder === '1') {
        filePath = path.join(__dirname, 'Brygady', 'Rzeszów', 'WYNIKI', 'Gotowe_brygady', '1', 'Rezerwa_list.txt');
    } else if (folder === '2') {
        filePath = path.join(__dirname, 'Brygady', 'Rzeszów', 'WYNIKI', 'Gotowe_brygady', '2', 'Rezerwa_list.txt');
    } else if (folder === '3') {
        filePath = path.join(__dirname, 'Brygady', 'Rzeszów', 'WYNIKI', 'Gotowe_brygady', '3', 'Rezerwa_list.txt');
    } else if (folder === '4') {
        filePath = path.join(__dirname, 'Brygady', 'Rzeszów', 'WYNIKI', 'Gotowe_brygady', '4', 'Rezerwa_list.txt');
    } else {
        return res.status(404).send('Nieznana ścieżka');
    }
...
app.get('/przystanki', (req, res) => {
    const filePath = path.join(__dirname, 'Brygady', 'Rzeszów', 'WYNIKI', 'Przystanki.txt');
