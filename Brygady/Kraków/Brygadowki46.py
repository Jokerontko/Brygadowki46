...
def StwórzBrygadyBIS():
    ...
    foldery_do_przetworzenia = ["Pon-Śr", "Czwartek", "Piątek", "Sobotni", "Niedzielny"]
...
def ZaproponujBrygadyBIS():
    base_paths = [
        "WYNIKI/Gotowe_brygady/Pon-Śr",
        "WYNIKI/Gotowe_brygady/Czwartek",
        "WYNIKI/Gotowe_brygady/Piątek",
                ...
                if os.path.isdir(folder_path):
                    ...
                    if os.path.exists(start_file) and os.path.exists(end_file):
                        ...
                        with open(start_file, "r", encoding="utf-8") as sf, open(end_file, "r", encoding="utf-8") as ef:
                            ...
                            found_any = True
                            if time_diff < 10:
                                if int(start_time.split(":")[0]) >= 18 and time_diff < 10:
...
def CzyBIS():
    ...
    folder_paths = ['WYNIKI/Gotowe_brygady/Pon-Śr', 'WYNIKI/Gotowe_brygady/Czwartek', 'WYNIKI/Gotowe_brygady/Piątek', 'WYNIKI/Gotowe_brygady/Sobotni' , 'WYNIKI/Gotowe_brygady/Niedzielny']
